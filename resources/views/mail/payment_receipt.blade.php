...
<div style="margin: 20px; background-color: whitesmoke; padding: 20px;">
    ...
    <p style="margin-top: 20px; font-size: 18px;">Thank you for investing with us. You can go to your dashboard to monitor how your investment grows.</p>

    <a href={{$data['webpage']}}/{{$data['user_category']}} target="_blank" style="margin-top: 30px;">
    ...
    <p style="font-weight: bold; font-size: 18px; color: blue; margin-top: 20px;">{{$data['webpage']}}/{{$data['user_category']}}</p>

<html>
    <body>
        ...
        <div style="margin: 20px; background-color: whitesmoke; padding: 20px;">
            ...
            <p style="margin-top: 20px; font-size: 18px;">Your account has been activated successfully. You can login and start
                buying slots in investment portfolios.</p>

            <a href={{$data['webpage']}} target="_blank" style="margin-top: 30px;">
                <p style="font-weight: bold; font-size: 18px; color: blue;">Click here to login</p>
            </a>

<html>
<body>
<h2 style="text-align: center; margin-top: 50px">Welcome!</h2>
<div style="margin: 20px; background-color: whitesmoke; padding: 20px;">
    ...
    <p style="margin-top: 20px; font-size: 18px;">We're excited to have you get started. First, you need to confirm your account.
        Click the link below to do so.</p>

    <a href={{$data['webpage']}}/verify_user/{{$data['encodedEmail']}} target="_blank" style="margin-top: 30px;">
    ...
    <p style="font-weight: bold; font-size: 18px; color: blue; margin-top: 20px;">{{$data['webpage']}}/verify_user/{{$data['encodedEmail']}}</p>
